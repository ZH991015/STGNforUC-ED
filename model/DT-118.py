...
# 展平数据，准备训练
X = expanded_x.reshape(-1, 288*118)  # 展平成二维数组，每个样本118个特征
y = newy.reshape(-1, 288*54)  # 展平成二维数组，每个样本54个输出
...
print(f"Mean Squared Error: {mse}")#0.82
print(f"Mean Absolute Error: {mae}")#0.032
