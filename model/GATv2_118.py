...
class GNN(torch.nn.Module):
    def __init__(self, num_node_features):
        ...
        self.conv1 = GATv2Conv(num_node_features,128,heads=4)
        self.conv2 = GATv2Conv(128*4, 64,heads=1)
        self.fc=torch.nn.Linear(64*118,15552)
...
def validate():
    ...
    with torch.no_grad():
        ...
        end_time=time.time()
        print("Validation time: {:.6f}s".format(end_time - start_time))
